...
M_Target = transpose(1:65); % For which maturities do we want the SW algorithm to calculate the rates. In this case, for every year up to 65.

%% Implementation
% The implementation is split in two parts. The calibration of the kernel functions 
% is done by the function Calibrate_b. The interpolation/extrapolation of targeted 
...
disp("The interpolated/extrapolated rates are:")
disp(r_Target)
